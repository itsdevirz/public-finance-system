        ...
        <CardContent className="pt-5 px-6 pb-5 space-y-5">
          ...
          <div className="grid grid-cols-2 gap-x-8 gap-y-4 md:grid-cols-4" dir="rtl">
            ...
            <Field label="دلیل اسقاط" required col={2}>
              <SearchableSelect value={form.scrapReason} onChange={v => { setForm(f => ({...f, scrapReason: v})); setSaved(false); }} options={SCRAP_REASONS} />
            </Field>
          ...
          <div className="rounded-xl border bg-muted/20 px-5 py-4">
            ...
            <div className="grid grid-cols-2 gap-x-8 gap-y-4 md:grid-cols-4" dir="rtl">
              ...
              <Field label="روش واگذاری" required col={2}>
                <SearchableSelect value={form.disposalMethod} onChange={v => { setForm(f => ({...f, disposalMethod: v})); setSaved(false); }} options={DISPOSAL_METHODS} />
              </Field>
          ...
          <div className="rounded-xl border bg-muted/20 px-5 py-4">
            ...
            <div className="grid grid-cols-2 gap-x-8 gap-y-4 md:grid-cols-4" dir="rtl">
              ...
              <Field label="وضعیت کمیسیون" required>
                <SearchableSelect value={form.commissionStatus} onChange={v => { setForm(f => ({...f, commissionStatus: v})); setSaved(false); }} options={COMMISSION_STATUS} />
              </Field>
